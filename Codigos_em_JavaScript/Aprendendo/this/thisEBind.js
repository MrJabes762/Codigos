const pessoa = {
    saudacao:'Bom dia',
    falar(){// novo recurso do ES6 que premite criar funções dentro de objetos dessa forma 
...
falar(); // na tentativa de armazenar uma função em uma variavel há um conflito entre paradigmas funcionais e orientada a objetos 
